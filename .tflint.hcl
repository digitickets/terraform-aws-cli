...
tflint {
  required_version = "0.64.0" # INFBASE_MAINTAINED_VERSION - This version is maintained by inf-base.
}
...
plugin "aws" {
  ...
  version    = "0.48.0" # INFBASE_MAINTAINED_VERSION - This version is maintained by inf-base.
  deep_check = true
}
